...
| `event`                         | Level | Meaning                                                                                                                                                                                                                                                                                                                                               |
| ------------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dispatcher.offer.sent`         | info  | An offer was sent to a selected daemon. Carries `kind`, `deliveryId`, `daemonId`, `offerId`, plus `fleetSize` + `requiredTools` for capacity/capability diagnostics.                                                                                                                                                                                  |
