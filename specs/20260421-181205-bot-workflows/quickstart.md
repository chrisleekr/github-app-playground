...
| Two tracking comments on one issue             | Indicates a duplicate run — should be impossible given the partial unique index                                      | File a bug; attach both tracking comment URLs + the DB rows.                                                                                               |
